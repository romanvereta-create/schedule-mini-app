(() => {
    ...
    async function start() {
        ...
        try {
            ...
            await loadScript('i18n.js?v=31.7.1');
            await loadScript('app.js?v=31.7.1');
            await loadScript('ux.js?v=31.7.1');
            await loadScript('personal_notifications.js?v=31.7.1');
            await loadScript('help.js?v=31.7.1');
            await loadScript('support.js?v=31.7.1');
            hideStatus();
        } catch (error) {
