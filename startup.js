(() => {
    ...
    async function start() {
        ...
        try {
            ...
            await loadScript('i18n.js?v=31.5.0-rc4');
            await loadScript('app.js?v=31.5.0-rc4');
            await loadScript('ux.js?v=31.5.0-rc4');
            await loadScript('personal_notifications.js?v=31.5.0-rc4');
            hideStatus();
        } catch (error) {
