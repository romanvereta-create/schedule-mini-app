(() => {
    ...
    async function start() {
        ...
        try {
            ...
            await loadScript('i18n.js?v=31.8.2');
            await loadScript('app.js?v=31.8.2');
            await loadScript('ux.js?v=31.8.2');
            await loadScript('personal_notifications.js?v=31.8.2');
            await loadScript('help.js?v=31.8.2');
            await loadScript('support.js?v=31.8.2');
            hideStatus();
        } catch (error) {
