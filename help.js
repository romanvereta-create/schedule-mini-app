...
(() => {
    ...
    const topics = [
        ...
        {id: 'lessons', title: ['Занятия: создание, перенос, отмена', 'Lessons: create, move, cancel'], items: [
            ...
            ['«Перенести»: перетащите занятие на нужный час или выберите свободный прямоугольник. Быстро отпустите — время станет ровно по началу часа. Подержите над часом 0,7 секунды — появится шкала для выбора с точностью 5 минут. Занятые места приглушены; затем выберите перенос одного, будущих или добавление копии.', 'Reschedule: drag a lesson to the needed hour or select a free rectangle. Release quickly to use the exact hour. Hold over the hour for 0.7 seconds to open a five-minute precision scale. Busy targets are dimmed; then choose one lesson, future lessons or a copy.'],
